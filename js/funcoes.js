...
//na chamada da função - argumento
...
console.log(`Multiplicando 5 x 15 = ${multiplicaValores(5,15)}`);
console.log(`Multiplicando 5 x 25 = ${multiplicaValores(5,25)}`);
console.log(`Multiplicando 5 x 35 = ${multiplicaValores(5,35)}`);
